...
import type { GenuiMaterialRegistry, MaterialDefaultValueMap } from '@opentiny/genui-sdk-core';
...
export const GENUI_MATERIALS: InjectionKey<GenuiMaterialRegistry> = Symbol('GENUI_MATERIALS');
