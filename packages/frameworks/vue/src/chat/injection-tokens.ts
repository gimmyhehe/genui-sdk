...
import type { GenuiMaterialsMap, IRendererConfig, MaterialDefaultValueMap } from '@opentiny/genui-sdk-core';
...
export const GENUI_RENDERER_CONFIG: InjectionKey<IRendererConfig> = Symbol('GENUI_RENDERER_CONFIG');
